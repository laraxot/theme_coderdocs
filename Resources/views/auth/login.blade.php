        ...
        <div class="row min-vh-100">
            <div class="col-md-8 col-lg-6 col-xl-5 d-flex align-items-center">
                <div class="w-100 py-5 px-md-5 px-xl-6 position-relative">
                    <div class="mb-5">
                        <img src="{{ Theme::asset('pub_theme::img/logo-square.svg') }}" alt="..." style="max-width: 4rem;"
                            class="img-fluid mb-3">
                        <h2>@lang('lu::auth.login.welcome_back')</h2>
                    </div>
                    ...
                    <form class="form-validate" role="form" method="POST"
                        ...
                        <!-- Submit-->
                        <button class="btn btn-lg btn-block btn-primary">@lang('lu::auth.sign_in')</button>
                        ...
                        <a href="{{ route('login.provider', ['lang' => $lang, 'provider' => 'facebook']) }}"
                            ...
                            @lang('lu::auth.login.connect_with_facebook')
                            {{-- Connect
                        ...
                        <a href="{{ route('login.provider', ['lang' => $lang, 'provider' => 'google']) }}"
                            ...
                            @lang('lu::auth.connect_with_google')
            ...
            <div class="col-md-4 col-lg-6 col-xl-7 d-none d-md-block">
                <!-- Image-->
                <div style="background-image: url({{ Theme::asset('pub_theme::img/photo/photo-1497436072909-60f360e1d4b1.jpg') }});"
