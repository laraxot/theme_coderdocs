...
//Theme::add('pub_theme::assets/plugins/jquery-3.4.1.min.js',1);
//Theme::add('pub_theme::assets/plugins/popper.min.js',2);
//Theme::add('pub_theme::assets/plugins/bootstrap/js/bootstrap.min.js',3);
...
//Theme::add('pub_theme::js/app.js');
Theme::add('https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.15.8/highlight.min.js');
Theme::add('pub_theme::assets/js/highlight-custom.js');
//Theme::add('pub_theme::assets/plugins/jquery.scrollTo.min.js');
//Theme::add('pub_theme::assets/plugins/lightbox/dist/ekko-lightbox.min.js');
Theme::add('pub_theme::assets/js/docs.js');
Theme::add('pub_theme::js/prism.js');
